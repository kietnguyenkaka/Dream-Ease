import '../tracking_gi_c_ng_page/widgets/trackinggi_cng_item_widget.dart';
import 'package:flutter/material.dart';
import 'package:sleep_demo/core/app_export.dart';
import 'package:sleep_demo/widgets/app_bar/appbar_subtitle.dart';
import 'package:sleep_demo/widgets/app_bar/appbar_subtitle_three.dart';
import 'package:sleep_demo/widgets/app_bar/appbar_trailing_image.dart';
import 'package:sleep_demo/widgets/app_bar/custom_app_bar.dart';

class TrackingGiCNgPage extends StatelessWidget {
  const TrackingGiCNgPage({Key? key}) : super(key: key);
                  ...
                  child: SizedBox(
                      ...
                      child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            return TrackinggiCngItemWidget();
                          }))),
              Padding(
                  ...
                  child: Row(
                      ...
                      children: [
                        Padding(
                            ...
                            child: Text("lbl_z".tr,
                                style: CustomTextStyles
                                    .titleSmallOpenSansWhiteA700Bold)),
                        Padding(
    ...
    return Container(
        ...
        decoration: BoxDecoration(
            image: DecorationImage(
                image: AssetImage(ImageConstant.imgGroup171),
                fit: BoxFit.cover)),
  ...
  /// Navigates to the sleepModeScreen when the action is triggered.
  onTapImage(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.sleepModeScreen);
  }
}
