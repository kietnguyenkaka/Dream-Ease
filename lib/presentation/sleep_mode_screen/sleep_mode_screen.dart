...
class SleepModeScreen extends StatelessWidget {
            ...
            body: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: AssetImage(ImageConstant.imgSleepMode),
                        fit: BoxFit.cover)),
                child: Container(
                              ...
                              children: [
                                Align(
                                    ...
                                    child: Padding(
                                        ...
                                        child: Text("lbl_good_night".tr,
                                            style: CustomTextStyles
                                                .bodyLargePoppinsWhiteA700))),
                                Align(
                                    alignment: Alignment.bottomCenter,
                                    child: Text("lbl_20_30".tr,
  ...
  /// Navigates to the suggestOneScreen when the action is triggered.
  onTapImgSwipeUp(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.suggestOneScreen);
  }
}
