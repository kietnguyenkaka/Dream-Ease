...
import 'package:sleep_demo/widgets/app_bar/appbar_subtitle_one.dart';
import 'package:sleep_demo/widgets/app_bar/custom_app_bar.dart';

class MusicSongScreen extends StatelessWidget {
  const MusicSongScreen({Key? key}) : super(key: key);
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        ...
        centerTitle: true,
        title: AppbarSubtitleOne(text: "msg_chillout_and_ambient".tr));
  }
  ...
  /// Navigates to the musicPlaylistScreen when the action is triggered.
  onTapImgUIIconHome(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.musicPlaylistScreen);
  }

  /// Navigates to the musicMGiTTNhCScreen when the action is triggered.
  onTapImgUIIconCloud(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.musicMGiTTNhCScreen);
  }
}
