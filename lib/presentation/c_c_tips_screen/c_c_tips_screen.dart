...
class CCTipsScreen extends StatelessWidget {
  CCTipsScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the khiNVCCTipsScreen when the action is triggered.
  onTapNineteen(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.khiNVCCTipsScreen);
  }
